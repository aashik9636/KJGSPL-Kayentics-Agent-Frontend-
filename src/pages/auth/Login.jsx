  ...
  return (
    <div className="w-full">
      <div className="mb-8 text-center flex flex-col items-center">
        <h2 className="text-[32px] font-medium text-[#111827] dark:text-white tracking-tight mb-2">Sign in</h2>
        <p className="text-[#6b7280] dark:text-neutral-400 text-[15px]">Enter your details to access your Kaynetics account</p>
      </div>
      ...
      <div className="space-y-3 mb-8">
        <button type="button" className="w-full flex items-center justify-center space-x-3 border border-neutral-200 dark:border-white/10 bg-white dark:bg-white/5 hover:bg-neutral-50 dark:hover:bg-white/10 rounded-xl py-3 px-4 shadow-sm dark:shadow-none transition-all duration-200">
          ...
          <span className="text-[14px] font-medium text-[#111827] dark:text-neutral-200">Continue with Google</span>
        </button>
        <button type="button" className="w-full flex items-center justify-center space-x-3 border border-neutral-200 dark:border-white/10 bg-white dark:bg-white/5 hover:bg-neutral-50 dark:hover:bg-white/10 rounded-xl py-3 px-4 shadow-sm dark:shadow-none transition-all duration-200">
          <svg className="w-5 h-5 text-[#0077b5]" fill="currentColor" viewBox="0 0 24 24">
            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
          </svg>
          <span className="text-[14px] font-medium text-[#111827] dark:text-neutral-200">Continue with LinkedIn</span>
        </button>
      </div>
      ...
      <form className="w-full space-y-5" onSubmit={handleLogin}>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-[12px] font-bold text-[#6b7280] dark:text-neutral-300 uppercase tracking-wide flex items-center gap-1.5">
