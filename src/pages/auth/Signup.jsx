  ...
  return (
    <div className="w-full">
      <div className="mb-8 text-center flex flex-col items-center">
        <h2 className="text-[32px] font-medium text-[#111827] dark:text-white tracking-tight mb-2">Create Account</h2>
        <p className="text-[#6b7280] dark:text-neutral-400 text-[15px]">Join Kaynetics to manage your AI agents</p>
      </div>
      ...
      <div className="space-y-3 mb-8">
        ...
        <button type="button" className="w-full flex items-center justify-center space-x-3 border border-neutral-200 dark:border-[#333333] bg-white dark:bg-[#1a1a1a] hover:bg-neutral-50 dark:hover:bg-[#262626] rounded-xl py-3 px-4 transition-colors">
          ...
          <span className="text-[14px] font-medium text-[#111827] dark:text-neutral-200">Sign up with LinkedIn</span>
        </button>
      </div>
      ...
      <form className="w-full space-y-5" onSubmit={handleSignup}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-[12px] font-bold text-[#6b7280] dark:text-neutral-300 mb-2 uppercase tracking-wide">First Name</label>
            <input
              type="text"
              placeholder="John"
              value={firstName}
          ...
          <div>
            <label className="block text-[12px] font-bold text-[#6b7280] dark:text-neutral-300 mb-2 uppercase tracking-wide">Last Name</label>
            <input
              type="text"
              placeholder="Doe"
              value={lastName}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button 
              ...
              className="absolute inset-y-0 right-0 pr-4 flex items-center text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-200 transition-colors focus:outline-none"
            >
              {showPassword ? (
          ...
          <p className="text-[11px] text-[#6b7280] dark:text-neutral-400 mt-1.5 ml-1">
        ...
        <div className="flex items-center mt-4">
          <input id="terms" type="checkbox" required className="w-4 h-4 rounded border-neutral-300 dark:border-[#333333] text-[#1967d2] focus:ring-[#1967d2]" />
          <label htmlFor="terms" className="ml-2 block text-[13px] font-medium text-[#6b7280] dark:text-neutral-400">
      ...
      <p className="mt-8 text-center text-[14px] text-[#6b7280] dark:text-neutral-400">
        Already have an account? <Link to="/login" className="text-[#1967d2] font-semibold hover:underline">Sign In</Link>
      </p>

      <div className="mt-12 pt-8 border-t border-neutral-100 dark:border-[#333333] flex items-center justify-center gap-6 text-[11px] font-bold tracking-wider text-[#9ca3af] dark:text-neutral-500 uppercase">
        <a href="#" className="hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors">Privacy</a>
        <div className="w-1 h-1 rounded-full bg-neutral-300 dark:bg-neutral-700"></div>
        <a href="#" className="hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors">Terms</a>
        <div className="w-1 h-1 rounded-full bg-neutral-300 dark:bg-neutral-700"></div>
        <a href="#" className="hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors">Help</a>
      </div>
    </div>
  );
}
